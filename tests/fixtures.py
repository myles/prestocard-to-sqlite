...
PRE_PROCESSED_TRANSACTION_HISTORY = pd.DataFrame(
    ...
    data=(
        ("1/9/2022 4:38:47 PM","Toronto Transit Commission","ST ANDREW STATION","Fare Payment","-$3.70"),
    )
)
...
POST_PROCESSED_TRANSACTION_HISTORY = pd.DataFrame(
    ...
    data=(
        (
            datetime.datetime(2022, 1, 9, 16, 38, 47, tzinfo=pytz.timezone("America/Toronto")),
